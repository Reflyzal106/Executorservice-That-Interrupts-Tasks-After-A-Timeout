# [SOLVED] Executorservice-That-Interrupts-Tasks-After-A-Timeout
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/executorservice-that-interrupts-tasks-after-a-timeout)
>
...
Use the ThreadPoolExecutor's setTimeLimit method or create a custom executor service using a ScheduledExecutorService and a ThreadFactory that sets a timeout for each task.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/executorservice-that-interrupts-tasks-after-a-timeout)**
